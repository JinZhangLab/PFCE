...
% libPLS_1.98 toolbox is used to build the PLS models.
% References:
...
n_comp = 3;
PLS = pls(Xc,yc,3,'center'); % PLS modeling for master 
b_m = PLS.regcoef_original([end,1:end-1]); % PLS model coefficients of master 
